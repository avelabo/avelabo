...
export default function Header({ isSticky, onMobileMenuToggle }) {
    const { currencies, counts, headerCategories, siteSettings, auth } = usePage().props;
                    ...
                    <div className="flex items-center justify-between gap-6 py-4 lg:py-5">
                        ...
                        <div className="flex items-center gap-2 lg:gap-1">
                            ...
                            >
                                ...
                                <span className="text-sm font-medium">{auth?.user ? `${auth.user.first_name.length > 10 ? auth.user.first_name.slice(0, 10) + '…' : auth.user.first_name}'s Account` : 'Sign in'}</span>
                            </Link>
