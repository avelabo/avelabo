...
export default function PromotionsEdit({ promotion, categories, brands, tags }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('seller.promotions.update', promotion.id));
    };
    ...
    return (
        <SellerLayout title="Edit Promotion">
            ...
            <div className="mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-2">Edit Promotion</h2>
                <p className="text-gray-500 text-sm">Update the details of your promotion</p>
            </div>
