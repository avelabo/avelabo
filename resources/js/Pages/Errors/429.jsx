                        ...
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            >
                                ...
                                <span className="relative inline-block">
                                    <span className="relative z-10">Down</span>
                            ...
                            {/* Subheadline */}
                            <p
                                className={`text-lg lg:text-xl text-[#666666] max-w-md mx-auto mb-8 leading-relaxed transition-all duration-700 delay-400 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                            >
                            ...
                            {/* Countdown */}
                            <div
                                className={`transition-all duration-700 delay-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                            >
                                <div className="flex flex-col items-center">
                                    <div className="w-20 h-20 sm:w-24 sm:h-24 bg-[#1a1a1a] rounded-xl flex items-center justify-center">
                            ...
                            {/* Action Button */}
                            <div
                                className={`mt-10 transition-all duration-700 delay-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                            >
                                <Link
                                    href="/"
