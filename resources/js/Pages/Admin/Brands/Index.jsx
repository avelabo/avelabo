...
export default function Index({ brands, filters, stats }) {
    ...
    const handleFilterChange = (key, value) => {
        router.get(route('admin.brands.index'), { ...filters, [key]: value || undefined }, { preserveState: true });
    };
    ...
    const toggleFeatured = (brand) => {
        router.patch(route('admin.brands.toggle-featured', brand.id));
    };
        ...
        <AdminLayout>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        <h2 className="text-2xl font-bold text-heading dark:text-white">Brands</h2>
                        <p className="text-body">Manage product brands</p>
                    </div>
                    <Link
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-white dark:bg-dark-card rounded-xl p-4 shadow-card">
                        <p className="text-sm text-body">Total Brands</p>
                            ...
                            <tbody className="divide-y dark:divide-white/10">
                                {brands?.data?.length > 0 ? (
                                    brands.data.map((brand) => (
                                        <tr key={brand.id} className="hover:bg-gray-50 dark:hover:bg-dark-body/50">
                                            ...
                                            <td className="px-6 py-4">
                                                ...
                                                >
                                                    <span className="material-icons">
                                                        {brand.is_featured ? 'star' : 'star_outline'}
                                                    </span>
                                                </button>
                                            </td>
                                    ...
                                    <tr>
                                        <td colSpan="5" className="px-6 py-12 text-center">
                                            ...
                                            <h3 className="text-lg font-medium text-heading dark:text-white mb-2">No brands found</h3>
                                            <p className="text-body mb-6">Get started by creating your first brand.</p>
                                            <Link
                                                href={route('admin.brands.create')}
