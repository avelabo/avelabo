...
export default function Create({ currencies, authTypes }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.import.data-sources.store'));
    };

    return (
        <AdminLayout>
            <Head title="Add Data Source" />
            ...
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-heading dark:text-white">Add Data Source</h2>
                        <p className="text-body">Configure a new external data source for imports</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white dark:bg-dark-card rounded-xl shadow-card p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-body">Endpoint to fetch all categories</p>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <p className="mt-1 text-xs text-body">Optional: Endpoint to search categories</p>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <p className="mt-1 text-xs text-body">Optional: Endpoint to fetch all products</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-body">Use {'{category_id}'} as placeholder for the category ID</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        >
                            {processing ? 'Creating...' : 'Create Data Source'}
                        </button>
                    </div>
                </form>
            </div>
