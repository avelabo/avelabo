...
export default function Create({ dataSources, sellers, categories, importTypes }) {
    ...
    useEffect(() => {
        if (data.data_source_id) {
            // Reset category selection when data source changes
            setData(prev => ({
                ...prev,
                source_category_id: '',
                source_category_name: '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.import.tasks.store'));
    };
        ...
        <AdminLayout>
            ...
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-heading dark:text-white">Create Import Task</h2>
                        <p className="text-body">Configure a new import task</p>
                    </div>
                </div>
                    ...
                    <div className="bg-white dark:bg-dark-card rounded-xl shadow-card p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g., Import Laptops from Takealot"
                            />
                        ...
                        <div className="bg-white dark:bg-dark-card rounded-xl shadow-card p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <select
                                        value={data.source_category_id || (data.source_category_name === 'All Categories' ? 'all' : '')}
